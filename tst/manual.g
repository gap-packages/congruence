...
# Congruence release. Also, it uses the file "lib/Examples.g" from the GAPDoc
# development version. So, to test Congruence under the GAP4 release, you 
# must copy these two files in appropriate places in the release branch.
#
...
Info( InfoCongruence, 1, "Test of ", path );
